...
def Quantiles1(in_features, in_field, in_quant):
...
def Quantiles2(in_features, in_field, in_quant):
    #print("converting to numpy")
    nparray = da.FeatureClassToNumPyArray(in_features,["OID@",in_field],skip_nulls = True)
    ...
    #print("Assign Quantiles")
    quants = AssignQuant(flcol,pso,minval) #quants was previously called "out"
